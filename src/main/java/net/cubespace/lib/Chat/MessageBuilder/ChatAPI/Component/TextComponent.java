package net.cubespace.lib.Chat.MessageBuilder.ChatAPI.Component;

import net.cubespace.lib.Chat.MessageBuilder.ChatAPI.ChatColor;
...
public class TextComponent extends BaseComponent
{
    ...
    public TextComponent(BaseComponent old) {
        super(old);
    }
