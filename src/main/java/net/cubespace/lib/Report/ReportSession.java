...
public class ReportSession {
    ...
    public ReportSession(CubespacePlugin plugin, String reportName) {
        ...
        plugin.getServer().getScheduler().runTaskAsynchronously(plugin, reportFileWriterTask);
    ...
    private void writeHeader() {
        ...
        write("BungeeCord: " + plugin.getServer().getVersion() + "; Java: " + System.getProperty("java.version"));
        write("");
    }
